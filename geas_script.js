...
function getDataset(choice) {
    ...
    if (choice === 'geas1') return geas_subject; // Adjust accordingly for other subjects
    if (choice === 'geas2') return geas_subject; // Adjust accordingly for other subjects
    if (choice === 'geas3') return geas_subject; // Adjust accordingly for other subjects
    if (choice === 'geas4') return geas_subject; // Adjust accordingly for other subjects
}
