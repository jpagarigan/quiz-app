...
function getDataset(choice) {
    ...
    if (choice === 'electronics1') return elex_subject; // Adjust accordingly for other subjects
    if (choice === 'electronics2') return elex_subject; // Adjust accordingly for other subjects
    if (choice === 'electronics3') return elex_subject; // Adjust accordingly for other subjects
    if (choice === 'electronics4') return elex_subject; // Adjust accordingly for other subjects
}
